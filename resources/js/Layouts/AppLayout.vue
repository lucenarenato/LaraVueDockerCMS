...
<template>
    <div>
        ...
        <div class="min-h-screen bg-base-100 dark:bg-gray-800 dark:text-white">
            <nav
                ...
                <div class="navbar-start">
                    <div class="dropdown">
                        ...
                        <ul tabindex="0"
                            class="p-2 mt-3 shadow menu menu-compact dropdown-content bg-base-100 dark:bg-gray-900 dark:text-white rounded-box w-52">
                            <li>
                            ...
                            <li tabindex="0">
                                <a class="justify-between">
                                    More
                                    <svg class="#62b570" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                    ...
                    <Link href="/" class="text-xl text-black normal-case btn btn-ghost dark:text-white">
                    {{ $page.props.appName }}
                    </Link>
                    <DonateModal />
                </div>
                        ...
                        <li tabindex="0">
                            <a>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="#62b570" stroke-width="2" stroke-linecap="round"
                ...
                <div v-if="$page.props.auth.user === null" class="navbar-end">
                    ...
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0"
                            class="p-2 shadow dropdown-content menu bg-base-100 rounded-box w-52 dark:bg-gray-900 dark:text-white">
                            <li>
                ...
                <div v-if="$page.props.auth.user !== null" class="navbar-end">
                    ...
                    <div v-if="$page.props.stux === true" class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0"
                            class="p-2 text-black shadow dropdown-content menu bg-base-100 rounded-box w-52 dark:bg-gray-900 dark:text-white">
                            <li>
                    ...
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0"
                            class="p-2 mt-3 text-black shadow menu menu-compact dropdown-content bg-base-100 dark:bg-gray-900 dark:text-white rounded-box w-52">
                            <li>
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-base-200 text-base-content dark:bg-gray-900 dark:text-white">
        ...
        <footer
            class="p-10 rounded footer footer-center bg-base-100 text-base-content dark:bg-gray-800 dark:text-white">
            ...
            <div>
                <div class="grid grid-flow-col gap-4">
                    ...
                    <a href="mailto:info@stux.info" class="p-2 rounded hover:bg-base-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
            ...
            <div>
                <p>© 2022. <a href="https://stux.info" target="_blank">@stux</a> · <a
                        href="https://github.com/mstdn/LaraVue" target="_blank">Source</a></p>
            </div>
        </footer>
